...
return [
    ...
    */
    ...
    'dimensions'       => 'ابعاد :attribute معتبر نیست.',
    ...
    */
    'attributes' => [
        ...
        "photo"                     => "تصویر",
        "meta_img"                  => "تصویر متا",
        "thumbnail_img"             => "تصویر اصلی",
        "category_id"               => "دسته کالا",
        "subcategory_id"            => " زیر دسته کالا",
        // "subsubcategory_id"         => "ریز زیر دسته",
        "subsubcategory_id"         => "محصول",
        "eng_title"                 => "عنوان انگلیسی",
        "banner"                    => "بنر",
        "icon"                      => "آیکون",
        "logo"                      => "لوگو",
        "rating"                    => "امتیاز",
        ...
        "receiver_codemeli"         => "کد ملی",
        "unit"                      => "واحد",
        "unit_price"                => "قیمت",
        "discount"                  => "تخفیف",
        "current_stock"             => "موجودی",
        ...
        "bank_id"                   => "نام بانک",
        "town_id"                   => "شهر",
        "payment_reference_code"    => "کد پیگیری پرداخت",
        "position"                  => "موقعیت",
        "postal_reference_code"     => "کد پیگیری پستی",
        "delivery_type"             => "روش ارسال",
        "pay_type"                  => "نوع پرداخت سفارش",
        "order_type"                => "نوع سفارش ",
        "default_shop_id"           => "فروشگاه پیش‌فرض",
        "units"                     => "واحدها",
        "slug"                      => "پیوند یکتا",
        "estimated_weight"          => "وزن تخمینی"
    ],
];